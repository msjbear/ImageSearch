...
public class MyENCrawler {
	...
	private static synchronized void saveToLocal(String url,String string) throws IOException {
		...
		int num = COUNT++;
		try {
			String fileName = "News_"+num+"_EN.html";
			...
			DataOutputStream out = new DataOutputStream(new FileOutputStream(new File(path+"/News_"+(num)+"_EN.html")));
		...
		System.out.println(url+"  News_"+num+"_EN.html  已抓取");
	}
